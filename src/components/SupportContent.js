...
const SupportContent = ({post1, setPost1, post2, setPost2}) => {
      ...
      <section>
        {/* <article>
         ...
         {post1?.map((item)=>{
            ...
            return <article key={id}><h2>{title}</h2><img src="https://images.unsplash.com/photo-1536196112245-64fda3a1df0b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=688&q=80" alt='hi' /></article>
          })}
